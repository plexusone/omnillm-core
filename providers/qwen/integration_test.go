...
// TestQwenIntegration_ChatCompletion tests actual API calls to Qwen
func TestQwenIntegration_ChatCompletion(t *testing.T) {
...
// TestQwenIntegration_Streaming tests actual streaming API calls to Qwen
func TestQwenIntegration_Streaming(t *testing.T) {
	apiKey := os.Getenv("QWEN_API_KEY")
	if apiKey == "" {
		t.Skip("Skipping integration test: QWEN_API_KEY not set")
	}
...
// TestQwenIntegration_ErrorHandling tests API error responses
func TestQwenIntegration_ErrorHandling(t *testing.T) {
	apiKey := os.Getenv("QWEN_API_KEY")
	if apiKey == "" {
		t.Skip("Skipping integration test: QWEN_API_KEY not set")
	}
