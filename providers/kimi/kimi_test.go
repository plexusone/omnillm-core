...
func TestKimiClient_CreateCompletion_Success(t *testing.T) {
	srv := newTestServer(t, http.StatusOK, chatCompletionResponse("moonshot-v1-8k", "test successful"))
	defer srv.Close()
...
func TestKimiClient_CreateCompletion_AuthorizationHeader(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(chatCompletionResponse("moonshot-v1-8k", "ok")))
	}))
	defer srv.Close()
...
func TestKimiClient_CreateCompletionStream_Success(t *testing.T) {
	srv := newStreamServer(t, "moonshot-v1-8k")
	defer srv.Close()
...
func TestKimiProvider_CreateChatCompletion_Success(t *testing.T) {
	srv := newTestServer(t, http.StatusOK, chatCompletionResponse("moonshot-v1-8k", "hello there"))
	defer srv.Close()
...
func TestKimiClient_CustomHTTPClient(t *testing.T) {
	srv := newTestServer(t, http.StatusOK, chatCompletionResponse("moonshot-v1-8k", "ok"))
	defer srv.Close()
