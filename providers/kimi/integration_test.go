...
func TestKimiIntegration_ChatCompletion(t *testing.T) {
	apiKey := os.Getenv("KIMI_API_KEY")
	if apiKey == "" {
		t.Skip("Skipping integration test: KIMI_API_KEY not set")
	}
...
// TestKimiIntegration_Streaming tests actual streaming API calls to Kimi
func TestKimiIntegration_Streaming(t *testing.T) {
	apiKey := os.Getenv("KIMI_API_KEY")
	if apiKey == "" {
		t.Skip("Skipping integration test: KIMI_API_KEY not set")
	}
...
// TestKimiIntegration_ErrorHandling tests API error responses
func TestKimiIntegration_ErrorHandling(t *testing.T) {
	apiKey := os.Getenv("KIMI_API_KEY")
	if apiKey == "" {
		t.Skip("Skipping integration test: KIMI_API_KEY not set")
	}
